...
from models.BertCRF import BertCRFModel, MSRAData, collate_fn
...
def evaluate(data_loader):
    ...
    with torch.no_grad():
        for batch_data in data_loader:
            ...
            outputs = model.get_outputs(input_ids=input_ids)
...
for epoch in range(EPOCHS):
    with tqdm(train_loader) as tt:
        ...
        print(
            f"epoch:{epoch:4}, Dev F1:{dev_f1:>5.2}, Dev recall: {dev_recall:>5.2}, Dev precision: {dev_precision:>5.2}")
